...
class LpgtvCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class LpgtvCertificatePostResponse(BaseModel):
...
class LpgtvCertificatePostResponse1(BaseModel):
...
class LpgtvCertificatePostResponse2(BaseModel):
...
class LpgtvCertificatePostResponse3(BaseModel):
...
class LpgtvCertificatePostResponse4(BaseModel):
...
class LpgtvCertificatePostResponse5(BaseModel):
...
class LpgtvCertificatePostResponse6(BaseModel):
